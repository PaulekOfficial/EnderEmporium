...
import {faExclamation, faGamepad, faPercent} from "@fortawesome/free-solid-svg-icons";
import $ from "jquery";
            ...
            <div className="overlay-content" onClick={(e) => e.stopPropagation()}>
                ...
                <div className={"overlay-content-header"}>
                    ...
                    <div className={"overlay-content-description"}>
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab ad, aliquam, assumenda cumque eius
                        eum hic labore
                        laudantium neque nesciunt nihil nisi odio, placeat reiciendis repellendus reprehenderit
                        repudiandae veniam
                        vitae! Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquam amet aut debitis
                        dignissimos
                        exercitationem hic id, itaque, magni nemo neque nisi nobis nulla placeat possimus quod, saepe
                        sapiente
                        veritatis? Excepturi.
                    </div>
                </div>
                <div className={"overlay-quantity"}>
                    ...
                    <input key={""} type="range" min="1" max="100" value="50" className={"overlay-content-slider"}
                           id="myRange"/>
                </div>
